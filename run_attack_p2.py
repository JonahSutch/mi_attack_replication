...
Example:
    python run_attack_p2.py
    python run_attack_p2.py --plot
    python run_attack_p2.py --train_sizes 2500 5000  # subset
...
def main():
    ...
    parser.add_argument('--attack_models_root', type=str,
                        default='./results/attack_models_p2',
                        help='Root dir written by train_attack_p2.py; '
    ...
    if args.plot:
        ...
        plot_accuracy_vs_gap(results,
            os.path.join(fig_dir, 'p2_attack_accuracy_vs_gap.png'))
        plot_attack_vs_baseline(results,
            os.path.join(fig_dir, 'p2_attack_vs_baseline.png'))
        plot_generalization_gaps(results,
            os.path.join(fig_dir, 'p2_generalization_gaps.png'))
